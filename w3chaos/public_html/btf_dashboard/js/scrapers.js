    ...
    function worker() {    //function to update request ***
        setInterval(function() {
			...
			//console.log("device alarm " + dev_alarm_col[i])
				...
				$("#dev_alarm_" + i).html('<a id="error_' + [i] + '" href="#mdl-device-alarm" role="button" data-toggle="modal" onclick="return show_dev_alarm(this.id);"><i style="cursor:pointer;" class="material-icons red">error</i></a>');
			} else {
                            $("#error_" + i).remove();
                            }    
                    }
			...
			//console.log("cu alarm " + cu_alarm_col[i])
                        if (cu_alarm_col[i] == 1) {
                            $("#cu_alarm_" + i).html('<a id="warning_' + [i] + '" href="#mdl-cu-alarm" role="button" data-toggle="modal" onclick="return show_cu_alarm(this.id);"><i style="cursor:pointer;" class="material-icons yellow">error</i></a>');
                        }  else if (cu_alarm_col[i] == 2) {
                            $("#cu_alarm_" + i).html('<a id="warning_' + [i] + '" href="#mdl-cu-alarm" role="button" data-toggle="modal" onclick="return show_cu_alarm(this.id);"><i style="cursor:pointer;" class="material-icons red">error</i></a>');
			} else  {  
                            $("#warning_" + i).remove();
                        }    
                    }
