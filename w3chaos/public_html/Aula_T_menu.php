...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/Aula_T_graph_menu.css" />
...
<script type="text/javascript" src="js_chart/js/flot/jquery.numberformatter-1.2.3.min.js"></script>
  ...
  <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css"-->
    ...
    <script type="text/javascript" src="webChaos/Aula_T_real.js"></script>
        ...
        <link rel="stylesheet" type="text/css" href="menu/Aula_T_menu.css" />
...
<script>
	...
	<div class="main">
		...
		<fieldset class="plot" id="plot_t">
		    ...
		    <!--div id="flot-placeholder1" class="grafico"></div-->
		    		    <!--div id="flot-placeholder1" style="width:500px;height:200px"></div-->
			<div id="flot-placeholder1"/>
		</fieldset>
		
		<fieldset class="plot" id="plot_s">
		    <legend>Humidity_AVG</legend>
		    <!--div id="flot-placeholder3" style="width:500px;height:200px"></div-->
			<div id="flot-placeholder2"/>
		</fieldset>
		
		<fieldset class="plot" id="plot_c">
		    <legend>[CO2]_AVG</legend>
		    <!--div id="flot-placeholder2" style="width:500px;height:200px"></div-->
		    	<div id="flot-placeholder3"/>
		</fieldset>
		
		<fieldset class="plot" id="plot_ts">
		    <legend>Temperature_Sup_AVG</legend>
		    <!--div id="flot-placeholder4" style="width:500px;height:200px"></div-->
		    	<div id="flot-placeholder4"/>
		</fieldset>
	...
	<script src="menu/js/borderMenu.js"></script>
